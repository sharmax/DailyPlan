...
RSpec.describe HabitsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested habit as @habit" do
      habit = Habit.create! valid_attributes
      get :show, params: {id: habit.to_param}, session: valid_session
  ...
  describe "GET #new" do
    it "assigns a new habit as @habit" do
      ...
      expect(assigns(:habit)).to be_a_new(Habit)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested habit as @habit" do
      habit = Habit.create! valid_attributes
      get :edit, params: {id: habit.to_param}, session: valid_session
      expect(assigns(:habit)).to eq(habit)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Habit" do
        expect {
          post :create, params: {habit: valid_attributes}, session: valid_session
        }.to change(Habit, :count).by(1)
      end

      it "assigns a newly created habit as @habit" do
        post :create, params: {habit: valid_attributes}, session: valid_session
        expect(assigns(:habit)).to be_a(Habit)
        expect(assigns(:habit)).to be_persisted
      end

      it "redirects to the created habit" do
        post :create, params: {habit: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Habit.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved habit as @habit" do
        post :create, params: {habit: invalid_attributes}, session: valid_session
        expect(assigns(:habit)).to be_a_new(Habit)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested habit" do
        habit = Habit.create! valid_attributes
        put :update, params: {id: habit.to_param, habit: new_attributes}, session: valid_session
        habit.reload
      ...
      it "assigns the requested habit as @habit" do
        habit = Habit.create! valid_attributes
        put :update, params: {id: habit.to_param, habit: valid_attributes}, session: valid_session
        expect(assigns(:habit)).to eq(habit)
      end
    ...
    context "with invalid params" do
      it "assigns the habit as @habit" do
        habit = Habit.create! valid_attributes
        put :update, params: {id: habit.to_param, habit: invalid_attributes}, session: valid_session
        expect(assigns(:habit)).to eq(habit)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested habit" do
      habit = Habit.create! valid_attributes
      expect {
        delete :destroy, params: {id: habit.to_param}, session: valid_session
      }.to change(Habit, :count).by(-1)
    end
